...
(function () {
  ...
  var D = [
    ...
    ['AI-vision sensorbox', 'computer vision sensor box', 'Computer-Vision-Sensorbox'],
    ...
    ['AI-vision slijtagemodel', 'computer vision wear model', 'Computer-Vision-Verschleißmodell'],
    ...
    ['AI-vision slijtagemodel getraind op duizenden uren echte Nederlandse en Duitse roltrap-beelden. Herkent scheuren, randslijtage, plaat-misalignment en losse voorwerpen, over merken heen.', 'computer vision wear model trained on thousands of hours of real Dutch and German escalator footage. Recognises cracks, edge wear, plate misalignment and loose objects, across brands.', 'Computer-Vision-Verschleißmodell, trainiert mit tausenden Stunden echtem niederländischem und deutschem Rolltreppen-Bildmaterial. Erkennt Risse, Kantenverschleiß, Platten-Fehlstellung und lose Gegenstände, markenübergreifend.'],
    ...
    ['Frontline AI-vision', 'Frontline computer vision', 'Frontline-Computer-Vision'],
    ...
    ['Sensor, edge-AI en integratie met uw systemen.', 'Sensor, edge computer vision and integration with your systems.', 'Sensor, Edge-Computer-Vision und Integration mit Ihren Systemen.'],

    ['Achtergrond', 'Background', 'Hintergrund'],
    ['Ambitie voor Stepguard', 'Ambition for Stepguard', 'Ambition für Stepguard'],
    ['Klik op een portret voor de achtergrond en ambities van elk teamlid.', 'Click a portrait for the background and ambitions of each team member.', 'Klicken Sie auf ein Porträt für den Hintergrund und die Ambitionen jedes Teammitglieds.'],
    ...
    /* Missing keys from inline i18n */
    ['Stepguard B.V., voorspellend roltrap-toezicht uit Nederland', 'Stepguard B.V., predictive escalator monitoring from the Netherlands', 'Stepguard B.V., Vorausschauende Eskalator-Überwachung aus den Niederlanden'],
    ['Voorspellend toezicht voor roltrappen · CE-conforme add-on', 'Predictive monitoring for escalators · CE compliant add-on', 'Vorausschauende Überwachung für Eskalatoren · CE-konformer Add-on'],
    ['Zie slijtage', 'See wear', 'Verschleiß sehen,'],
    ['voordat het', 'before it', 'bevor er Sie'],
    ['u stopt.', 'stops you.', 'stoppt.'],
    ['Stepguard is a computer vision sensor and asset management platform that watches every rig of an escalator in real time, flagging wear, damage and unsafe conditions weeks before they fail.', 'Stepguard is a computer vision sensor and asset management platform that watches every rig of an escalator in real time, flagging wear, damage and unsafe conditions weeks before they fail.', 'Stepguard ist ein Computer vision Sensor und Asset-Management-Plattform, der jede Rig eines Eskalators in Echtzeit überwacht, Verschleiß, Schäden und unsichere Zustände werden Wochen bevor sie ausfallen gemeldet.'],
    ['Boek een demo van 20 min', 'Book a 20-min demo', '20-Min-Demo buchen'],
    ['In ontwikkeling met', 'In development with', 'In Entwicklung mit'],
    ['Bereken uw jaarlijkse besparing.', 'Calculate your annual savings.', 'Berechnen Sie Ihre jährlichen Einsparungen.'],
    ['Live · Indicatief', 'Live · Indicative', 'Live · Indikativ'],
    ['Besparing', 'Savings', 'Einsparungen'],
